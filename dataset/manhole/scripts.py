...
def process_dataset(labels_folder_path, images_folder_path):
    ...
    remove_indices = {'1'}  # Indices to remove(path-hole)
    index_mapping = {'0': '11'}  # Indices to change(manhole)
...
process_dataset(
    labels_folder_path="C:\\Users\\abt\\Documents\\Real-time-obstacle-detector\\data sets\\manhole\\train\\labels",
    images_folder_path="C:\\Users\\abt\\Documents\\Real-time-obstacle-detector\\data sets\\manhole\\train\\images"
)

process_dataset(
    labels_folder_path="C:\\Users\\abt\\Documents\\Real-time-obstacle-detector\\data sets\\manhole\\test\\labels",
    images_folder_path="C:\\Users\\abt\\Documents\\Real-time-obstacle-detector\\data sets\\manhole\\test\\images"
)

process_dataset(
    labels_folder_path="C:\\Users\\abt\\Documents\\Real-time-obstacle-detector\\data sets\\manhole\\valid\\labels",
    images_folder_path="C:\\Users\\abt\\Documents\\Real-time-obstacle-detector\\data sets\\manhole\\valid\\images"
)
