...
def process_dataset(labels_folder_path, images_folder_path):
    ...
    remove_indices = {'0','2'}  # Indices to remove(path-hole)
    index_mapping = {'1': '13'}  # Indices to change(manhole)
...
process_dataset(
    labels_folder_path="C:\\Users\\abt\\Documents\\Real-time-obstacle-detector\\data sets\\gaurdrail\\train\\labels",
    images_folder_path="C:\\Users\\abt\\Documents\\Real-time-obstacle-detector\\data sets\\gaurdrail\\train\\images"
)

process_dataset(
    labels_folder_path="C:\\Users\\abt\\Documents\\Real-time-obstacle-detector\\data sets\\gaurdrail\\test\\labels",
    images_folder_path="C:\\Users\\abt\\Documents\\Real-time-obstacle-detector\\data sets\\gaurdrail\\test\\images"
)

process_dataset(
    labels_folder_path="C:\\Users\\abt\\Documents\\Real-time-obstacle-detector\\data sets\\gaurdrail\\valid\\labels",
    images_folder_path="C:\\Users\\abt\\Documents\\Real-time-obstacle-detector\\data sets\\gaurdrail\\valid\\images"
)
